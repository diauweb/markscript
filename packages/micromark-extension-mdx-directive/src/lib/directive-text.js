/**
 * @import {Construct, Effects, Previous, State, TokenizeContext, Tokenizer} from 'micromark-util-types'
 ...
 * @returns {Construct}
 */
export function directiveText(options) {
  /** @type {Construct} */
  const attributes = {
  ...
  return {
    tokenize(effects, ok, nok) {
      return tokenizeDirectiveText.call(this, effects, ok, nok, attributes)
    },
    previous,
  }
}
 ...
 * @returns {State}
 */
function tokenizeDirectiveText(effects, ok, nok, attributes) {
  const self = this
