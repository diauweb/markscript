...
export function factoryAttributes(
  ...
  /** @type {State} */
  function afterSpreadExpression(code) {
    return between(code)
  }
  ...
  function between(code) {
    if (code === codes.leftCurlyBrace) {
      return factoryMdxExpression.call(
        self,
        effects,
        afterSpreadExpression,
        /** @type {TokenType} */ (`${attributeType}Expression`),
        /** @type {TokenType} */ (`${attributeType}ExpressionMarker`),
        /** @type {TokenType} */ (`${attributeType}ExpressionValue`),
        expressionOptions.acorn,
        expressionOptions.acornOptions,
        expressionOptions.addResult,
        true,
        false,
        false,
      )(code)
  ...
  /** @type {State} */
  function afterValueExpression(code) {
    effects.exit(attributeType)
    return between(code)
  }
  ...
  function valueBefore(code) {
    if (code === codes.leftCurlyBrace) {
      return factoryMdxExpression.call(
        self,
        effects,
        afterValueExpression,
        /** @type {TokenType} */ (`${attributeType}ValueExpression`),
        /** @type {TokenType} */ (`${attributeType}ValueExpressionMarker`),
        /** @type {TokenType} */ (`${attributeType}ValueExpressionValue`),
        expressionOptions.acorn,
        expressionOptions.acornOptions,
        expressionOptions.addResult,
        false,
