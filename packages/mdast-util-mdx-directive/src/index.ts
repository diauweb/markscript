...
import {
  directiveFromMarkdown as fromMarkdown,
  directiveToMarkdown as toMarkdown,
} from './lib/index.js'

export const directiveFromMarkdown = fromMarkdown
export const directiveToMarkdown = toMarkdown
...
interface DirectiveFields {
  ...
  /** Ordered MarkScript attributes, including expressions and spreads. */
  directiveAttributes?: Array<DirectiveAttribute> | null | undefined
...
export interface DirectiveExpression {
  ...
  value: string
  data?: {estree?: unknown} | undefined
}

export interface DirectiveNamedAttribute {
  type: 'mdxJsxAttribute'
  name: string
  value: string | null | DirectiveExpression
  position?: Position | undefined
}

export interface DirectiveSpreadAttribute {
...
export type DirectiveAttribute =
  | DirectiveNamedAttribute
  | DirectiveSpreadAttribute
...
declare module 'mdast-util-from-markdown' {
  interface CompileData {
     ...
     */
    directiveAttributes?: Array<[string, string, boolean?]> | undefined
    markscriptDirectiveAttributes?: Array<DirectiveAttribute> | undefined
  }
}
